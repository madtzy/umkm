...
<div class="l-navbar" id="nav-bar">
    <nav class="nav">
        <div>
            ...
            <div class="nav__list">
                <a href="<?php echo base_url('admin/dashboard_admin') ?>" class="nav__link text-white">
                ...
                <a class="nav__link text-white dropdown-bs-toggle" data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
                ...
                <a href="<?php echo base_url('admin/data_warung/index') ?>" class="nav__link text-white">
                ...
                <a href="<?php echo base_url('admin/data_riwayat/index') ?>" class="nav__link text-white">
                ...
                <a href="<?php echo base_url('admin/data_mitra/index') ?>" class="nav__link text-white">
